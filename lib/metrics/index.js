...
const availableMetrics = {
  ...
  'accused-company': require('./accused-company'),
  'profiles': require('./profiles'),
  'needed-elements': require('./needed-elements'),
  'area': require('./area'),
  'qualification-level': require('./qualification-level'),
  'learning-mode': require('./learning-mode'),
  'category': require('./category'),
  'incapacity': require('./incapacity'),
  'reach': require('./reach'),
  'personal-victim-data': require('./personalVictimData')
};
