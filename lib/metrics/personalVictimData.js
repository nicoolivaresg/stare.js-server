...
function calculate(stareDocument, opts) {
  return new Promise((resolve, reject) => {
    ...
    if (_.has(stareDocument, 'body.edadAFechaLesion')) {
        _.extend(personalData, { edad: _.get(stareDocument, 'body.edadAFechaLesion') })
    }
    
    if (_.has(stareDocument, 'body.sexoVictima')) {
        _.extend(personalData, { sexo: _.get(stareDocument, 'body.sexoVictima') })
    }
