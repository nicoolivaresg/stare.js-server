...
const BASE_URL_SII_API = 'https://siichile.herokuapp.com/consulta?rut=';
    ...
    return new Promise((resolve, reject) => {
      let result = (async () => {
        ...
        if (similarBusiness !== undefined){
          ...
          // API para consultar datos básicos de la empresa desde SII
          let response = await gaxios.request({
            url: BASE_URL_SII_API +_.get(similarBusiness, 'RUT'),
            method: 'GET',
            responseType: 'json',
          });
